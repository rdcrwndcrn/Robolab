...
class Robot:
    def __init__(self):
        ...
        # coordinates last node, for calc cord current node (x, y)
        # TODO safe corrected coordinates in self.robo.coordinates__last_node after path correct
        self.coordinates_last_node = (0, 0)
